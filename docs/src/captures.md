...
- **Descripció:** Mostra el formulari de registre d'usuaris, amb camps per a nom d'usuari, correu electrònic i contrasenya. ![Descripció de la imatge](registre_front.png)
- Desde backend veient en la llista de players com s'ha afegit correctament:
![Descripció de la imatge](registre_back.png)
...
![Descripció de la imatge](gameLobby.png)
...
![Descripció de la imatge](front.png)
