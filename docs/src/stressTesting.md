...
- Unir-se a partides que estiguin esperant jugadors.
...
- Permet unir-se a partides amb menys de dos jugadors.
- Sempre jugant contra el bot i no et pots unir a partides on ets el owner.

### Crear nova partida

- Redirigeix directament a la pantalla del joc.
- Permet començar una partida que posteriorment un altre jugador pot unir-se.

### Veure i gestionar les meves partides

- L’usuari pot veure totes les partides en què ha participat.
- Possibilitat de continuar partides si no han acabat (`phase !== 'gameOver'`).
- Possibilitat d’eliminar partides individuals o totes les seves partides.

## Limitacions actuals

- **No hi ha connexió multijugador en temps real**: cada acció necessita una crida HTTP per actualitzar l'estat.
